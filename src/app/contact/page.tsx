  ...
  return (
    <>
      ...
      <main>
        <PageHero
          eyebrow="Contact"
          title="Let's build your payment growth together."
          description="Reach out to our team — whether you're scaling a fintech, expanding a marketplace, or launching a new digital service, we'll help you go to market faster."
        />
        ...
        <section className="mt-4 px-4 sm:px-6 lg:mt-6 lg:px-20">
          <ScrollReveal>
            <div
              className="relative grid grid-cols-1 items-center gap-8 overflow-hidden rounded-[24px] p-7 sm:p-10 lg:grid-cols-[1.2fr_1fr] lg:gap-10 lg:rounded-[30px] lg:p-12"
              style={{
                background:
            ...
            >
              ...
              <div className="relative text-black">
                ...
                <p className="mt-4 text-[16px] leading-relaxed text-[#1f2230]">
                  Book a 30-minute intro with our solutions team — we&apos;ll
                  walk through your use case and the fastest path to launch.
                </p>
                <a
                  href="https://wa.me/0000000000"
                  target="_blank"
              ...
              <div className="relative h-[280px]">
                <Image
                  src="/images/illustration/illustration11.webp"
                  alt="Talk to Airpay"
                  fill
